...
export default function render (m, sz) {
	...
	// kulcsszám
	var kulcsszam = db / 10 + mb / 10 * 0.5 - 5 + 1.5;

	p[2] = p[1].down(kulcsszam + 1.5)
	...
	var derekbeallitas = 3 + 0.5;
	p[19] = p[6].left(derekbeallitas);

	var aljabeallitas = 4 + 0.5;
	...
	p[38] = p[36].left(l('33-36').length / 2 + kulcsszam / 2);
	...
	var mellnyitas = kulcsszam / 2 + 0.5;
